...
const URL_VACANCY = 'https://platform-homologx.senior.com.br/t/senior.com.br/bridge/1.0/rest/hcm/recruitment/entities/vacancy'
const BODY_DATA_LEADER = require('../json/moods/leaderSituation');
const BODY_DATA_VACANCY = require('./json/remuneration/vacancy');
...
describe('Scenario', function () {
    ...
    it('Retornas gestores na hierarquia', function () {
        return service.postRequest(URL_LEADERSSITUATION, BODY_DATA_LEADER)
            .expect('status', 200)
            .expect('jsonTypes', {
